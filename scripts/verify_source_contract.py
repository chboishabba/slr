...
checks = {
    ...
    'unsupported residual has relative-fine dependency fibre': 'SL_EXPANDED_UNSUPPORTED_DEP label=' in expanded_cert and 'unsupported_dependency_fibre' in expanded_cert,
    ...
    'expanded gwb v0.4 residual refinement accounted': 'sensiblaw.gwb-expanded-semantic-certification-receipt.v0_4' in gwb_expanded and 'unsupported_dependency_fibre_sums_to_coarse_residual' in gwb_expanded and 'same_unsupported_dependency_relative_fibre_across_passes' in gwb_expanded,
    'relative-fine residual diagnostic does not change semantic authority': '"changes_semantic_authority": False' in gwb_expanded and '"changes_canonical_consumer_observation": False' in gwb_expanded,
